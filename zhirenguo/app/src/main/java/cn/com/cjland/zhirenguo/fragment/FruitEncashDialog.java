...
public class FruitEncashDialog extends DialogFragment implements View.OnClickListener{
    private Context mContext;
    private ImageView mEncashClose;
    private Button mBtnEncash;
    /**
     * 处理activity传递过来的值
     */
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fruit_encash_layout, container);
        mBtnEncash = (Button) view.findViewById(R.id.btn_encash);
        mBtnEncash.setOnClickListener(this);
        mEncashClose = (ImageView) view.findViewById(R.id.iv_encash_close);
        mEncashClose.setOnClickListener(this);
        return view;
    }
    @Override
